...
class CatalogServiceTest extends ApiTestCase
{
    ...
    public function testGetProductWithMultipleOptions()
    {
        ...
        $this->assertEquals($expectedDeclinations, $product->getDeclinations());
        $this->assertEquals($expectedOptions, $product->getOptions());
        $this->assertEquals($expectedDeclinations[1], $product->getDeclinationFromOptions([['optionId' => '9', 'variantId' => '5'], ['optionId' => '10', 'variantId' => '9']]));
        $this->assertEquals($expectedDeclinations[4], $product->getDeclinationFromOptions([['optionId' => '9', 'variantId' => '6'], ['optionId' => '10', 'variantId' => '9']]));
        $this->assertEquals($expectedDeclinations[7], $product->getDeclinationFromOptions([['optionId' => '9', 'variantId' => '7'], ['optionId' => '10', 'variantId' => '9']]));
        $this->assertEquals($expectedDeclinations[10], $product->getDeclinationFromOptions([['optionId' => '9', 'variantId' => '8'], ['optionId' => '10', 'variantId' => '9']]));
        $this->assertEquals($expectedDeclinations[2], $product->getDeclinationFromOptions([['optionId' => '9', 'variantId' => '5'], ['optionId' => '10', 'variantId' => '10']]));
    }
