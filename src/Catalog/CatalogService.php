...
final class CatalogService extends AbstractService implements CatalogServiceInterface
{
    ...
    {
        $response = $this->client->get('catalog/products', [RequestOptions::QUERY => ['code' => $code, 'allowMvp' => $allowMvp ? 1 : 0]]);
    ...
    {
        $response = $this->client->get('catalog/products', [RequestOptions::QUERY => ['mvpId' => $mvpId, 'allowMvp' => $allowMvp ? 1 : 0]]);
